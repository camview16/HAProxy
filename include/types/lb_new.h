...
#ifndef _TYPES_LB_FWNW_H
#define _TYPES_LB_FWNW_H
...
struct lb_new {
	struct fwnw_group act;	/* weighted round robin on the active servers */
	struct fwnw_group bck;	/* weighted round robin on the backup servers */
};

#endif /* _TYPES_LB_FWNW_H */
